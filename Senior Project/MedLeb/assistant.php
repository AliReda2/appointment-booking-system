    ...
    <div class="app-container">
        <div class="app-header">
            ...
            <div class="app-header-right">
                <button class="profile-btn">
                    ...
                    <span>
                        <?php
                        $sql = "SELECT name FROM assistant where id=$Aid";
                        $result = mysqli_query($con, $sql);
                        $row = mysqli_fetch_array($result);
                        echo $row["name"];
                        ?>
        ...
        <div class="app-content">
            ...
            <div class="projects-section" id="appointments" style="display:none">
                ...
                <div class="project-boxes jsGridView">
                    <form action="assistant-bookAppointment.php" method="post">
                        <p>Patient Name</p>
            ...
            <div class="projects-section" id="addRecords" style="display:none">
                ...
                <div class="project-boxes jsGridView">
                    <form action="newRecordA.php" method="post" enctype="multipart/form-data">
                        <p>Patient Name</p>
            ...
            <div class="projects-section" id="settings" style="display:none;overflow:auto">
                ...
                <div class="doctor-profile">
                    ...
                    <div class="form-container">
                        ...
                        <?php
                        $sql = "SELECT * FROM assistant where id=$Aid";
                        $result = mysqli_query($con, $sql);
                        $row = mysqli_fetch_array($result);
                        $dName = $row["name"];
                        $dPhone = $row["phone"];
                        $dEmail = $row["email"];
                        ?>
                        <form id="changeFormElement" action="update-assistant.php" method="POST">
                    ...
                    <div style="padding: 1.3rem 1rem;width: -webkit-fill-available;background: #f1f4f9;">
                        <div style="width: 100%;overflow: auto;">
                            <div style="padding: 1rem;display: flex;justify-content: space-between;align-items: center;">
                                ...
                                <div style="display: flex;align-items: center;">
                                    <input type="search" placeholder="Search" style="height: 35px;border: 1px solid #b0b0b0;border-radius: 3px;display: inline-block;padding: 0rem .5rem;margin-right: .8rem;color: #666;" class="record-search" onkeyup="filterTableP()">
                                </div>
                            </div>
                            <div>
                                <?php
                                $sql = "SELECT DISTINCT p.id, p.d_id, p.name, p.email, p.phone, p.dob FROM patient p LEFT JOIN appointment a ON p.id = a.p_id LEFT JOIN records r ON p.id = r.p_id WHERE a.d_id = ? OR r.d_id = ? OR p.d_id=?";
                                $stmt = $con->prepare($sql);
                                $stmt->bind_param("iii", $Did, $Did, $Did); // Assuming $Did is an integer
                                $stmt->execute();
                                $result = $stmt->get_result();
                                ...
                                ?>
                                    <table id="patientTable" width="100%" style="border-collapse: collapse;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <td>
                                                    <a href="deletePatientA.php?id=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure?')">
                ...
                <div class="newPatientD" style="display: none;top: 0;position: absolute;width: -webkit-fill-available;">
                    <div class="login-page">
                        <div class="form">
                            <form action="addPatientA.php" method="post">
